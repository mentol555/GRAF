...
int main() {
    ...
    // skalazasost valtoztatunk benne
    GLfloat matrix2[] = {
      1.0f,
      0.0f,
      0.0f,
    ...
    while (!glfwWindowShouldClose(g_window)) {
        ...
        //matrix1[13] = elapsed_seconds * speed + last_position;
        //matrix2[0] = elapsed_seconds * speed + last_position;
        //matrix2[5] = elapsed_seconds * speed + last_position;
        //matrix2[10] = elapsed_seconds * speed + last_position;

        // forgasss
        double szog = glfwGetTime() / 0.5;
        ...
        //std::cout<< elapsed_seconds * speed + last_position<<endl;
        last_position = szog;
